...
#dindex_3 {
	...
	<%@ include file="../top_front.jsp" %>
		<div id="dindex_2" class="tjdzj_listnews">
			<h2>
				<a>您所在的位置</a>-><a href="">首页</a>-><a>地方政府规章列表</a>
			</h2>
			<ul>
				<li>
					<table width="90%" border="0">
									...
									<s:iterator value="regularList">
										<tr>
											<td><s:url id="test" action="regular_front">
													<s:param name="regular.regularTitle" value="%{regularTitle}" />
													<s:param name="regular.regularContent"
														value="%{regularContent}" />
												</s:url> <s:a href="%{test}">${regularTitle}</s:a></td>
										</tr>
									</s:iterator>
								</s:bean>
							</s:if>
						...
						value="pageNow" /> 页 <s:url id="url_pre"
						value="regular_list">
						<s:param name="pageNow" value="pageNow-1"></s:param>
					</s:url> <s:url id="url_next" value="regular_list">
						<s:param name="pageNow" value="pageNow+1"></s:param>
					</s:url>
