...
<li></li>
  ...
  <table width="98%" border="0">
        <s:form method="post" action="regular_update" namespace="/" theme="simple" onsubmit="return checkForm();">
  ...
  <tr>
	  ...
	  <th width="80%" >
	  	<div id="sTime" class="input-group date form_date">
			<input name="regular.regularSTime" class="form-control" value="${regular.regularSTime}">
  ...
  <tr>
	  ...
	  <th width="80%" >
	  	<div id="iTime" class="input-group date form_date">
			<input name="regular.regularITime" class="form-control" value="${regular.regularITime}">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		</div>
	  </th>
  </tr>
  ...
  <tr>
	  <th width="10%">效力状况</th>
	  <th width="80%" >
	  	<input type="radio" name="regular.regularETime" value="有效" <c:if test="${regular.regularETime eq '有效'}">checked="checked"</c:if>/>有效
	  	<input type="radio" name="regular.regularETime" value="失效" <c:if test="${regular.regularETime eq '失效'}">checked="checked"</c:if>/>失效
	  </th>
  </tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
