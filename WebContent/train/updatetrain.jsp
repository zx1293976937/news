...
<li></li>
  ...
  <s:form method="post" action="train_update" namespace="/" theme="simple" onsubmit = "return checkForm();">
    ...
    <tr>
	  ...
	  <th width="80%" >
	  	<div id="sTime" class="input-group date form_date">
			<input name="train.trainSTime"  id = "trainSTime" maxlength = "45" class="form-control" value="${train.trainSTime}">
    ...
    <tr>
	  ...
	  <th width="80%" >
	  	<div id="iTime" class="input-group date form_date">
			<input name="train.trainETime" class="form-control" value="${train.trainETime}">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		</div>
	  </th>
  </tr> --%>
