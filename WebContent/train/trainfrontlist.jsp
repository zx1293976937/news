...
<div class="box">
	<div class="row">
		<div class="col-xs-12">
			<div class="alert alert-info">
				您所在的位置<b class="tip"></b><a href="info_queryAllInfo">首页</a><b class="tip"></b><a href="#">法制培训列表</a>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form action="train_list" method="post" class="form-inline" onsubmit = "return checkForm();">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-bordered table-condensed">
				...
				<tbody>
				<s:if test="%{trainList.size()>3}">
							<s:bean name="org.apache.struts2.util.Counter" id="counter">
								<s:param name="first" value="1" />
								<s:param name="last" value="trainList.size()" />
								<s:iterator value="trainList">
									<tr>
										<td><s:url id="test" action="train_front">
												<s:param name="train.trainId" value="%{trainId}" />
												<s:param name="train.trainContent" value="%{trainContent}" />
											</s:url> <s:a href="%{test}">${trainTitle}</s:a></td>
											<td style="width:30%"><s:a>${trainUTime}</s:a></td>
									</tr>
								</s:iterator>
							</s:bean>
						</s:if>
				...
				<tfoot>
					...
					<mytag:paging urlAction="train_list" type="1" />
					</td>
					</tr>
				</tfoot>
			</table>
