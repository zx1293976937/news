...
<div class="main">
  <div class="m-t"></div>
  <div class="breadcrumbs"> <a href="info_queryAllInfo">首页</a><span>></span><a href="regular_list">地方政府规章</a><span>> ${regular.regularTitle}</span> </div>
  <!--breadcrumbs end-->
  <div class="m-t"></div>
   <div class="a-r"><a href="#" id="print"><em class="blue">【打 印】</em></div>
  <div class="detail" id="detail">
    <div class="title">
      <h1>${regular.regularTitle}</h1>
      <div class="textcon"><span>发布时间：${regular.regularUTime}</span></div>
    </div>
    <div class="pictext">
