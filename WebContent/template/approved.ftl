...
<div class="main">
  <div class="m-t"></div>
  <div class="breadcrumbs"> <a href="info_queryAllInfo">首页</a><span>></span><a href="approved_list">非/行政许可审批</a><span>> ${approved.approvedTitle}</span> </div>
  <!--breadcrumbs end-->
  <div class="m-t"></div>
  <div class="a-r"><a href="#" id="print"><em class="blue">【打 印】</em></div>
  <div class="detail" id="detail">
    <div class="title">
      <h1>${approved.approvedTitle}</h1>
      <div class="textcon"><span>发布时间：${approved.approvedUTime}</span></div>
    </div>
    <div class="pictext">
