...
<div class="main">
  <div class="m-t"></div>
  <div class="breadcrumbs"> <a href="info_queryAllInfo">首页</a><span>></span><a href="train_list">法制培训</a><span>> ${train.trainTitle}</span> </div>
  <!--breadcrumbs end-->
  <div class="m-t"></div>
  <div class="a-r"><a href="#" id="print"><em class="blue">【打 印】</em></div>
  <div class="detail" id="detail">
    <div class="title">
      <h1>${train.trainTitle}</h1>
      <div class="textcon"><span>发布时间：${train.trainUTime}</span></div>
    </div>
    <div class="pictext">
      ${train.trainContent}
      <div class="clear"></div>
