...
<div class="main">
  <div class="m-t"></div>
  <div class="breadcrumbs"> <a href="info_queryAllInfo">首页</a><span>></span><a href="news_list">工作信息</a><span>> ${news.newsTitle}</span> </div>
  <!--breadcrumbs end-->
  <div class="m-t"></div>
  ...
  <div class="detail" id="detail">
    <div class="title">
      ...
      <div class="textcon"><span>发布时间：${news.newsUTime}</span></div>
    </div>
    <div class="pictext" style="width:100%;overflow:auto;">
      ${news.newsContent}
      <div class="clear"></div>
    </div>
  </div>
