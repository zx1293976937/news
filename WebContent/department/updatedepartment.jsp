...
<script>
	KindEditor.ready(function(K) {
    	K.create('#department_content',{resizeType:0});
	});
</script>
</head>
<body>
...
<h2><a>您所在的位置</a>-><a href="manage.jsp">首页</a>-><a>行政许可和非行政许可审批</a></h2>
<ul>
<li></li>
  <li>
  <table width="98%" border="0">
        <s:form method="post" action="department_update" namespace="/" theme="simple">
        <s:hidden name="department.departmentId"></s:hidden>
  <tr>
      <th width="5%"></th>
	  <th width="10%">部门名称</th>
	  <th width="80%" ><s:textfield name="department.departmentName"></s:textfield></th>
  </tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  <tr>
      <th width="5%"></th>
	  <th width="10%">上级单位</th>
	  <th width="80%" ><s:textfield name="department.departmentParent"></s:textfield></th>
  </tr>
