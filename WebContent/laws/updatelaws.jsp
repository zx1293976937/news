...
<li></li>
  ...
  <table width="98%" border="0">
        <s:form method="post" action="laws_update" namespace="/" theme="simple" onsubmit="return checkForm();">
  ...
  <tr>
	  ...
	  <th width="80%" ><s:select list="{'防震减灾综合','地震侦测预报','震灾预防','应急救援','其他'}" name="laws.lawsField"></s:select></th>
  </tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  ...
  <tr>
	  ...
	  <th width="80%" >
	 	<div id="sTime" class="input-group date form_date">
			<input name="laws.lawsSTime" class="form-control" value="${laws.lawsSTime}">
  ...
  <tr>
	  ...
	  <th width="80%" >
	    <div id="iTime" class="input-group date form_date">
			<input name="laws.lawsITime" class="form-control" value="${laws.lawsITime}">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		</div> 
	  </th>
  </tr>
  ...
  <tr>
	  <th width="10%">效力状况</th>
	  <th width="80%" >
	  	<input type="radio" name="laws.lawsETime" value="有效"  <c:if test="${laws.lawsETime eq '有效'}">checked="checked"</c:if>/>有效
	  	<input type="radio" name="laws.lawsETime" value="失效" <c:if test="${laws.lawsETime eq '失效'}">checked="checked"</c:if>/>失效
	  </th>
  </tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
