...
<li></li>
  ...
  <table width="98%" border="0">
        <s:form method="post" action="laws_add" namespace="/" theme="simple">
  <tr>
      <th width="5%"></th>
	  <th width="10%">法规名称</th>
  ...
  <tr>
      <th width="5%"></th>
	  <th width="10%">制定时间</th>
	  <th width="80%" ><sx:datetimepicker name="laws.lawsSTime" displayFormat="yyyy-MM-dd" value="todayDate" />
</th>
  </tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  ...
  <tr>
      <th width="5%"></th>
	  <th width="10%">实施时间</th>
	  <th width="80%" ><sx:datetimepicker name="laws.lawsITime" type="date" displayFormat="yyyy-MM-dd " language="UTF-8" displayWeeks="6" /></th>
  </tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  ...
  <tr>
      <th width="5%"></th>
	  <th width="10%">颁布机关</th>
	  <th width="80%" ><%-- <s:textfield name="laws.lawsPublisher"></s:textfield> --%>
