...
<li></li>
  ...
  <table width="98%" border="0">
        <s:form method="post" action="employee_update" namespace="/" theme="simple" onsubmit = "return checkForm();"> 
    ...
    <tr>
	  ...
	  <th width="80%" >
	  	<div id="sTime" class="input-group date form_date">
			<input name="employee.employeeBirthday" class="form-control" value="${employee.employeeBirthday}">
    ...
    <tr>
	  ...
	  <th width="80%" >
	    <div id="iTime" class="input-group date form_date">
			<input name="employee.employeeIssuedTime" class="form-control"  id = "employeeIssuedTime" maxlength = "45" value="${employee.employeeIssuedTime}">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		</div>
	  </th>
  </tr>
  <%-- <tr><th></th></tr>
   ...
   <tr><th></th></tr>
    ...
    <tr>
	  ...
	  <th width="80%" > 
	  	<input type="radio" name="employee.employeeFPTime" value="专职" <c:if test="${employee.employeeFPTime eq '专职'}">checked="checked"</c:if>/>专职
	  	<input type="radio" name="employee.employeeFPTime" value="兼职" <c:if test="${employee.employeeFPTime eq '兼职'}">checked="checked"</c:if>/>兼职
	  </th>
  </tr>
