...
<div class="box">
	<div class="row">
		<div class="col-xs-12">
			<div class="alert alert-info">
				您所在的位置<b class="tip"></b><a href="info_queryAllInfo">首页</a><b class="tip"></b><a href="#">法制宣传列表</a>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form action="propaganda_list" method="post" class="form-inline" onsubmit = "return checkForm();">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-bordered table-condensed">
				...
				<tbody>
				<s:if test="%{propagandaList.size()>3}">
							<s:bean name="org.apache.struts2.util.Counter" id="counter">
								<s:param name="first" value="1" />
								<s:param name="last" value="propagandaList.size()" />
								<s:iterator value="propagandaList">
									<tr>
										<td><s:url id="test" action="propaganda_front">
												<s:param name="propaganda.propagandaId"
													value="%{propagandaId}" />
												<s:param name="propaganda.propagandaContent"
													value="%{propagandaContent}" />
											</s:url> <s:a href="%{test}">${propagandaTitle}</s:a></td>
											<td style="width:30%"><s:a>${propagandaUTime}</s:a></td>
									</tr>
								</s:iterator>
							</s:bean>
						</s:if>
				...
				<tfoot>
					...
					<mytag:paging urlAction="propaganda_list" type="1" />
					</td>
					</tr>
				</tfoot>
			</table>
