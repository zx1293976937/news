			...
			<ul>
				...
				<li>
					<table width="98%" border="0">
						<s:form method="post" action="propaganda_update" namespace="/"
							theme="simple" onsubmit = "return checkForm();">
            <s:hidden name="propaganda.propagandaId"></s:hidden> 
							<tr>
								<th width="15%">法制宣传名称 <font color="#ff0000">*</font></th>
							...
							<tr>
								<th width="10%">法制宣传内容</th>
								<th width="80%"><s:textarea id="propaganda_content" name="propaganda.propagandaContent" style="width:700px;height:300px;"></s:textarea></th>
							</tr>
							<tr>
								<th></th>
							</tr>
							...
							<tr>
								...
								<th width="80%" >
									<div id="sTime" class="input-group date form_date">
										<input name="propaganda.propagandaSTime" id = "propagandaSTime" maxlength = "45" class="form-control" value="${propaganda.propagandaSTime}">
							...
							<tr>
								...
								<div id="iTime" class="input-group date form_date">
									<input name="propaganda.propagandaETime" class="form-control" value="${propaganda.propagandaETime}">
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
								</div>
								</th>
							</tr> --%>
							...
							<tr>
								<th width="10%">法制宣传地点 <font color="#ff0000">*</font></th>
							...
							<tr>
								<th width="10%">法制宣传范围</th>
								
								<th width="80%"><s:checkboxlist list="#{'广播':'广播','报纸':'报纸','电视':'电视'
								,'微博':'微博','网站':'网站','科普馆':'科普馆','公益广告':'公益广告' }" 
								name="propaganda.propagandaRange" value="%{listRange}"
								></s:checkboxlist></th>
							</tr>
							<tr>
								<th></th>
							...
							<tr>
								...
								<th width="80%"><s:select list="{'100以下','100--500人','500人以上'}" name="propaganda.propagandaPeople" id = "propagandaPeople" maxlength = "45"></s:select></th>
							</tr>
							<tr>
								<th></th>
							</tr>
							...
							<tr>
								...
								<s:hidden name="propaganda.propagandaProvince"></s:hidden>
								<s:hidden name="propaganda.propagandaParentUnit"></s:hidden>
