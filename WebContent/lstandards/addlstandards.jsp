...
<li></li>
  ...
  <table width="98%" border="0">
        <s:form method="post" action="lstandards_add" namespace="/" theme="simple" onsubmit="return checkForm();">
   <tr>
  ...
  <tr>
	  ...
	  <div id="sTime" class="input-group date form_date">
			<input name="lstandards.lstandardsSTime" class="form-control">
   ...
   <tr>
	  ...
	  <div id="iTime" class="input-group date form_date">
			<input name="lstandards.lstandardsITime" class="form-control">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		</div></th>
  </tr>
  ...
  <tr>
	  ...
	  <div id="eTime" class="input-group date form_date">
			<input name="lstandards.lstandardsETime" class="form-control">
			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		</div></th>
  </tr>
  <tr>
