...
<h2><a>您所在的位置</a>-><a href="manage.jsp">首页</a>-><a>地方标准</a>
<ul>
<li>	
<h4>
<s:a action="lstandards_addUI" namespace="/">添加地方标准</s:a>
</h4>
...
<li>
	...
	<tr>
                ...
                <th style="width:10%">标准编号</th>
                <th style="width:15%">标准名称</th>
                <th style="width:15%">制定时间</th>
                <th style="width:15%">实施时间</th>
                <th style="width:15%">失效时间</th>
                <th style="width:15%">颁布机关</th>
	...
	<td><s:a action="lstandards_updateUI" namespace="/">
	<s:param name="lstandards.lstandardsId">${lstandardsId}</s:param>修改</s:a><s:a action="lstandards_delete" namespace="/">
	<s:param name="lstandards.lstandardsId">${lstandardsId}</s:param>删除</s:a></td>
	</tr>
	</s:iterator>
	</table></li><li>
	<a>共 <s:property value="intRowCount" /> 记录	     
	第 <s:property value="pageNow" /> 页<s:url id="url_pre" value="lstandards_queryAllLstandards">
	<s:param name="pageNow" value="pageNow-1"></s:param>
	</s:url>
	<s:url id="url_next" value="lstandards_queryAllLstandards">
	<s:param name="pageNow" value="pageNow+1"></s:param>
	</s:url>
	</a>
	<s:if test="pageNow==1">
