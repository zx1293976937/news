...
<li></li>
  ...
  <s:form method="post" action="lawagency_add" namespace="/" theme="simple" onsubmit = "return checkForm();">
...
<!--   <tr><th></th></tr>
  ...
  <tr>
	  ...
	  <th width="80%" >
	  	<input type="radio" name="lawagency.lawagencyProperty" value="是"/>是
	  	<input type="radio" name="lawagency.lawagencyProperty" value="否" checked="checked"/>否
	  </th>
  </tr>
 -->  <tr><th></th></tr>
  <tr><th></th></tr>
  ...
  <tr>
	  ...
	  <th width="80%" >
	    <div id="citychoose">
			<select class="prov" name="lawagency.lawagencyAddressProvince" value="天津"></select> <br>
  ...
  <tr><th></th></tr>
  <tr>
	  <th width="12%">主要负责人出生日期</th>
	  <th width="80%" >
	  	<div id="sTime" class="input-group date form_date">
			<input name="lawagency.lawagencyInchargeBirthday" class="form-control">
  ...
  <tr>
	  ...
	  <th width="80%" >
	  	<input type="radio" name="lawagency.lawagencyInchargeSex" value="男"/>男
	  	<input type="radio" name="lawagency.lawagencyInchargeSex" value="女"/>女
	  </th>
  </tr>
  <tr><th></th></tr>
  <tr><th></th></tr>
  ...
  <tr>
	  ...
	  <th width="80%" >
	  	<input type="radio" name="lawagency.lawagencyInchargeLN" value="是"/>是
	  	<input type="radio" name="lawagency.lawagencyInchargeLN" value="否" checked="checked"/>否
	  </th>
  </tr>
  <tr><th></th></tr> 
  <tr><th></th></tr>
