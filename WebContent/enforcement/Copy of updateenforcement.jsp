...
<li></li>
  ...
  <s:form method="post" action="enforcement_update" namespace="/" theme="simple">
  ...
  <tr>
   ...
   <tr><th></th></tr>
    <tr>
	  ...
	  <th width="80%" ><s:radio list="#{'是':'是','否':'否'}" name="enforcement.enforcementInchargeLN"></s:radio> </th>
  </tr>
 ...
 <tr><th></th></tr>
   ...
   <tr><th></th></tr>
    ...
    <tr>
	  ...
	  <th width="5%"></th>
	  <th width="10%">上级单位</th>
	  <th width="80%" ><s:textfield name="enforcement.enforcementParentUnit"></s:textfield> </th>
  </tr>
