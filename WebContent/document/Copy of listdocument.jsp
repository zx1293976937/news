...
<h2><a>您所在的位置</a>-><a href="manage.jsp">首页</a>-><a>规范性文件</a>
<ul>
<li>
<h4>
<s:a action="document_addUI" namespace="/">添加规范性文件</s:a>
</h4>
...
<li>
	...
	<td><s:a action="document_updateUI" namespace="/">
	<s:param name="document.documentId">${documentId}</s:param>修改</s:a><s:a action="document_delete" namespace="/">
	<s:param name="document.documentId">${documentId}</s:param>删除</s:a></td>
	</tr>
	</s:iterator>
	</table></li><li>
	<a>共 <s:property value="intRowCount" /> 记录	     
	第 <s:property value="pageNow" /> 页<s:url id="url_pre" value="document_queryAllDocument">
	<s:param name="pageNow" value="pageNow-1"></s:param>
	</s:url>
	<s:url id="url_next" value="document_queryAllDocument">
	<s:param name="pageNow" value="pageNow+1"></s:param>
	</s:url>
	</a>
	<s:if test="pageNow==1">
