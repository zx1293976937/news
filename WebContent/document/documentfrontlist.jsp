...
<div class="box">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form action="document_list" method="post" class="form-inline" onsubmit="return checkSearchForm();">
		...
		<div class="col-xs-12">
			...
			<table class="table table-bordered table-condensed">
								...
								<s:iterator value="documentList">
									<tr>
										<td><s:url id="test" action="document_front">
											...
											<td style="width:30%"><s:a>${documentUTime}</s:a></td>
									</tr>
								</s:iterator>
							</s:bean>
						</s:if>
				...
				<tfoot>
					...
					<mytag:paging urlAction="document_list" type="1" />
					</td>
					</tr>
				</tfoot>
			</table>
