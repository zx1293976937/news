			...
			<ul>
				...
				<li>
					<table width="98%" border="0">
						<s:form name="addUser" method="post" action="user_add"
							namespace="/" theme="simple">
							<tr>
								<th width="30%"></th>
								<th width="10%">账号</th>
								<th width="60%"><s:textfield name="user.userName"></s:textfield>
								</th>
							</tr>
							<tr>
								<th></th>
							...
							<tr>
								<th width="30%"></th>
								<th width="10%">密码</th>
								<th width="60%"><s:password name="user.passWord"></s:password></th>
							</tr>
							<tr>
								<th></th>
							</tr>
							...
							<tr>
								...
								<th width="10%">所在单位</th>
								<th width="60%">
								<s:select list="%{listProvince}" name="user.inchargeMent"></s:select>
							...
							<tr>
								<th width="30%"></th>
								<th width="10%"></th>
								<th width="60%"><s:submit value="提交"></s:submit>&nbsp;&nbsp;&nbsp;&nbsp;
